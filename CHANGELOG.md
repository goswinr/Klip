...
- Accumulate polygon areas relative to a local origin with compensated summation, so a small area far from the global origin is not erased by absolute-coordinate shoelace terms.
